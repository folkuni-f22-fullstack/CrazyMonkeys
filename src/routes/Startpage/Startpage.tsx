            ...
            <main className="mainstartpage">
                <div className="text-container">
                    ...
                    <p className="companytitletext-p">
                        Fusionmat är den kreativa konsten att kombinera olika matkulturer och smaker
                        för att skapa helt nya, spännande rätter.
                    </p>
                ...
                >
                    ...
                    <div className="body-text">
                        ...
                        koriander, nötiga jordnötter och fräscha lime, vilket ger en oemotståndlig
                        smakupplevelse i varje tugga. Den kombinerar det bästa av öst och väst i en
                        pasta som är både djärv och harmonisk på samma gång.
                    </div>
                </motion.div>
                ...
                >
                    ...
                    <div className="body-text">
                        ...
                        teriyaki med den fräscha krispigheten av grönsaker och nori, vilket ger en
                        spännande smakupplevelse i varje tugga.
                    </div>
                </motion.div>
                <div className="btn-grad-div">
                    <Link to="/menu" className="btn-grad">
                        Gå till Meny
                    </Link>
                </div>
